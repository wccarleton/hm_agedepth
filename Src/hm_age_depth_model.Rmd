...
# funcion for rounding if a column is numeric (for print/publication formatting of the age-depth summary)
...
hm_data_with_agedepth_rnd <- hm_data_with_agedepth
for(j in 1:ncol(hm_data_with_agedepth_rnd)){
    hm_data_with_agedepth_rnd[, j] <- round_numeric(hm_data_with_agedepth_rnd[, j])
}

write.table(hm_data_with_agedepth_rnd,
